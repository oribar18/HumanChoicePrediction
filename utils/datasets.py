...
class OnlineSimulationDataSet(Dataset):
    ...
    class SimulatedUser:
        def __init__(self, threshold, user_improve, basic_nature, favorite_topic_method, **args):
            ...
            self.ACTIONS = {0: ("correct - oracle", 0, user_strategies.correct_action),
                            ...
                            6: ("sentimental analysis", basic_nature[5], user_strategies.sentiment_confidence_based(self.threshold, user_strategies.correct_action)),
                            }
    ...
    def play_round(self, bot_message, user, previous_rounds, hotel, review_id):
        ...
        user.ACTIONS[6] = ("sentimental analysis", user.basic_nature[5],
                           lambda info: user_strategies.sentiment_confidence_based(user.threshold,
                                                                                   user_strategies.correct_action)(
                               info))
